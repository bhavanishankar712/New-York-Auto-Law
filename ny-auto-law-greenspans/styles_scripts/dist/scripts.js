...
jQuery(document).ready(function ($) {
  $(".tab-btn-group .tab-btn").on("click", function (e) {
    ...
    const $tabContent = $this.closest(".tabs-block").find(".tab-content-area .tab-pane").eq(index);
    $tabContent.addClass("tab-pane-active").siblings(".tab-pane").removeClass("tab-pane-active");
  });
});
